...
def load_data(params):
    ...
    if params['dset'] == 'reuters':
        ...
        x_train = np.genfromtxt(os.path.join(ProjectDir,'Comp399_Instances.csv'), delimiter=",")
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = np.genfromtxt(os.path.join(ProjectDir,'Comp399_labels.csv'), delimiter=",")
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'sparse303':
        x_train = np.genfromtxt(os.path.join(ProjectDir,'sparse303_Instances.csv'), delimiter=",")
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = np.genfromtxt(os.path.join(ProjectDir,'sparse303_labels.csv'), delimiter=",")
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'ring238':
        x_train = np.genfromtxt(os.path.join(ProjectDir,'ring238_Instances.csv'), delimiter=",")
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = np.genfromtxt(os.path.join(ProjectDir,'ring238_labels.csv'), delimiter=",")
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)        
    elif params['dset'] == 'Agg788':
        x_train = np.genfromtxt(os.path.join(ProjectDir,'Agg788_Instances.csv'), delimiter=",")
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = np.genfromtxt(os.path.join(ProjectDir,'Agg788_labels.csv'), delimiter=",")
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)        
    elif params['dset'] == 'sparse622':
        x_train = np.genfromtxt(os.path.join(ProjectDir,'sparse622_Instances.csv'), delimiter=",")
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = np.genfromtxt(os.path.join(ProjectDir,'sparse622_labels.csv'), delimiter=",")
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'iris':
        iris = datasets.load_iris()
        x_train = iris['data']
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = iris['target']
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'wine':
        wine = datasets.load_wine()
        x_train = wine['data']
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = wine['target']
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'BreastCancer':
        BreastCancer = datasets.load_breast_cancer()
        x_train = BreastCancer['data']
        x_test = np.ndarray(shape=(0,x_train.shape[1]), dtype=x_train.dtype)
        y_train = BreastCancer['target']
        y_test = np.ndarray(shape=(0,), dtype=y_train.dtype)
    elif params['dset'] == 'digits':
