...
if args.dset == 'cc':
    ...
    params.update(Comp399_params)
elif args.dset == 'sparse303':
    sparse303_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 303,                      # number of total points in dataset
        # training parameters
        'n_clusters': 3,
        'use_code_space': False,
        # 'affinity': 'full',
    ...
    params.update(sparse303_params)
elif args.dset == 'ring238':
    ring238_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 238,                      # number of total points in dataset
        # training parameters
        'n_clusters': 3,
        'use_code_space': False,
        # 'affinity': 'full',
...
elif args.dset == 'sparse622':
    sparse622_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 622,                      # number of total points in dataset
        # training parameters
        'n_clusters': 5,
        'use_code_space': False,
        # 'affinity': 'full',
    ...
    params.update(sparse622_params)    
elif args.dset == 'iris':
    iris_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 150,                      # number of total points in dataset
        # training parameters
        'n_clusters': 3,
        'use_code_space': False,
        # 'affinity': 'full',
    ...
    params.update(iris_params)
elif args.dset == 'wine':
    wine_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 178,                      # number of total points in dataset
        # training parameters
        'n_clusters': 3,
        'use_code_space': False,
        # 'affinity': 'full',
    ...
    params.update(wine_params)
elif args.dset == 'BreastCancer':
    BreastCancer_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 569,                      # number of total points in dataset
        # training parameters
        'n_clusters': 2,
        'use_code_space': False,
        # 'affinity': 'full',
    ...
    params.update(BreastCancer_params)
elif args.dset == 'digits':
    digits_params = {
        # data generation parameters
        'train_set_fraction': 1.,       # fraction of the dataset to use for training
        'noise_sig': 0,               # variance of the gaussian noise applied to x
        'n': 1797,                      # number of total points in dataset
        # training parameters
        'n_clusters': 10,
        'use_code_space': False,
        # 'affinity': 'full',
...
# if args.dset in ['cc', 'Comp399', 'sparse303', 'ring238', 'Agg788', 'Sparse622']:
#     # run plotting script
#     import plot_2d
